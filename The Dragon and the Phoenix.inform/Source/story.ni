...
The ball is here. "[if park is unvisited]Mom pulls out your favourite chewed out tennis ball, and throws it. 'Go [bold type]fetch the ball[roman type], Dragon!'. The tennis ball rolls next to a large tree.[otherwise]Your favourite ball is sitting next to a large tree.[end if]". 
Mom is a person in the park.  "Mom is waiting for you."

Understand "fetch [something]" as taking.

After taking the ball:
	say "'Now [bold type]give me the ball[roman type], Dragon!'".

After giving the ball to Mom:
